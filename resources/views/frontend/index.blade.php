             ...
             <div class="container">
                 <div class="tabs_inner">
                     <ul class="nav nav-tabs" id="myTab" role="tablist">
                         ...
                         <li class="nav-item">
                             <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="true">Education</a>
                         </li>
                         <li class="nav-item">
                            <a class="nav-link" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="false">My Work</a>
                        </li>
                         <li class="nav-item">
                            <a class="nav-link" id="experience-tab" data-toggle="tab" href="#experience" role="tab" aria-controls="profile" aria-selected="false">Experience</a>
                        </li>
                     </ul>
                         ...
                         <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                             <ul class="list">
                                 <li>
                                     ...
                                     <div class="media">
                                         <div class="d-flex">
                                             <p>2020 to 2024 (expected)</p>
                                         </div>
                                         <div class="media-body">
                                             <h4>Computer Engineering</h4>
                                             <p>Diponegoro University, <br />Indonesia (Latest GPA 3.85)</p>
                                         </div>
                                     </div>
                                 </li>
                                 <li>
                                     ...
                                     <div class="media">
                                         ...
                                         <div class="media-body">
                                             <h4>SMA N 1 Wates</h4>
                                             <p>Science <br />(Passed SBMPTN to <br /> Diponegoro University)</p>
                                         </div>
                                     </div>
                                 </li>
                                 <li>
                            ...
                            <ul class="list">
                                ...
                                <li>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4>Karang Taruna Sinar Bhakti</h4>
                                            <p>Vice Chairman</p>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4>Super Engineering Squad 2020</h4>
                                ...
                                <li>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4>Dewan Pelatih Pleton Inti SMA N 1 Wates</h4>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4>Pleton Inti SMA N 1 Wates</h4>
                                        </div>
                                    </div>
                                </li>
                            </ul>
